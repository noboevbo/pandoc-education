...
This is an info text\addQRCode{https://zumvideo.de}. Suchmaschinen, wie zum Beispiel \textbf{google.de}
...
\hypertarget{asdsad}{%
\section{KA-Aufgabe 1: Image\marginpoints{9}}\label{asdsad}}

\hypertarget{exercise-image}{%
\section{Exercise: Image\marginexercise\hfill\normalsize\faIcon[regular]{clock} 8}\label{exercise-image}}
...
\begin{enumerate}
  \item Items are numbered automatically.\\ \drawLines{2}
